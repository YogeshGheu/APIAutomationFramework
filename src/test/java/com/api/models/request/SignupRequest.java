...
public class SignupRequest {
    ...
    public static class Builder{
        ...
        public SignupRequest build(){
            if(username == null || password == null || email == null || firstName == null || lastName ==null || mobileNumber ==null){
                throw new IllegalStateException("all mandatory parameters were not provided !");
            }
